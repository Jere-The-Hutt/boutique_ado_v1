...
ALLOWED_HOSTS = [
    ...
    'jere-the-hutt-boutique-ado-35483996acb1.herokuapp.com',  # Heroku app
]
...
if 'USE_AWS' in os.environ:
    # Bucket Config
    AWS_STORAGE_BUCKET_NAME = 'jere-the-hutt-boutique-ado'  # change this to your AWS bucket name
